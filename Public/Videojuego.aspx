...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex flex-column">
        <div>
            ...
            <asp:TextBox ID="NombreAdminBox" runat="server"/>
        </div>
        <div>
            <asp:Label Text="<b>Código:</b> " runat="server"/>
            <asp:Label Text="" ID="CodigoLabel" runat="server"/>
            <asp:TextBox TextMode="Number" ID="CodigoAdminBox" runat="server"/>
        </div>
        <div>
            <asp:Label Text="<b>Tipo:</b> " runat="server"/>
            <asp:Label Text="" ID="TipoLabel" runat="server"/>
            <asp:TextBox ID="TipoAdminBox" runat="server"/>
        </div>
        <div class="d-flex flex-column">
            <asp:Label Text="<b>Descripción:</b> " runat="server"/>
            <asp:Label Text="" ID="DescripcionLabel" runat="server"/>
            <asp:TextBox TextMode="MultiLine" ID="DescripcionAdminBox" runat="server"/>
        </div>
        <div>
            <asp:Label Text="<b>Edad mínima:</b> " runat="server"/>
            <asp:Label Text="" ID="EdadMinimaLabel" runat="server"/>
            <asp:TextBox TextMode="Number" ID="EdadMinimaAdminBox" runat="server"/>
        </div>
    </div>
    <asp:Label Text="" ID="DebugLabel" runat="server"/>
    <asp:Button Text="Actualizar entrada" ID="AdminUpdate" runat="server"/>
    <asp:Button Text="Borrar entrada" ID="AdminDelete" runat="server"/>
    <asp:Button Text="Añadir entrada" ID="AdminAdd" runat="server"/>
</asp:Content>
