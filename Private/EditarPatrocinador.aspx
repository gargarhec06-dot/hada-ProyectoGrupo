...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="editar-wrapper">
        ...
        <div class="page-title">Editar Patrocinador</div>
        ...
        <div class="form-card">
            <div class="form-field">
                ...
                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre"
                    ErrorMessage="* obligatorio" CssClass="field-error" Display="Dynamic" />
            </div>
            <div class="form-field">
            ...
            <div class="form-field">
                ...
                <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
                    ...
                    ErrorMessage="Email no válido" CssClass="field-error" Display="Dynamic" />
            </div>
            <div class="form-field">
        ...
        <div class="section-title">Torneos que patrocina</div>
                ...
                <tr>
                    <td style="text-align: center;">
                        <asp:CheckBox ID="chkPatrocina" runat="server"
                            onclick="if(!this.checked){ this.parentNode.parentNode.querySelector('input[type=text]').value='0'; }" />
